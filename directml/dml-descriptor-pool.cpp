...
namespace Dml
{
    ...
    std::unique_ptr<DescriptorRange> DescriptorHeap::TryAllocDescriptors(
        ...
        )
    {
        ...
        auto range = std::make_unique<DescriptorRange>(m_heap.Get(), m_headCpuHandle, m_headGpuHandle);
